    ...
    LateDataCollectorInterface
{
    ...
    public function collect(
        ...
        $this->data = [
            ...
            "stateless_check" =>
                ...
                $mainRequest->attributes->get("_stateless", false),
            "flashes" => $flashes,
    ...
    public function isJsonRequest()
    {
        return 1 ===
            preg_match(
                ...
                $this->data["request_headers"]["content-type"]
            );
    }
    ...
    public function collectSessionUsage(): void
    {
        ...
        for ($i = $traceEndIndex; $i > 0; --$i) {
            if (
                null !== ($class = $trace[$i]["class"] ?? null) &&
                (is_subclass_of($class, SessionInterface::class) ||
                    is_subclass_of($class, SessionBagInterface::class))
            ) {
                $traceEndIndex = $i;
                break;
            }
            ...
            if (
                $class =
                    \PHP_VERSION_ID >= 80111
                        ? $r->getClosureCalledClass()
                        : $r->getClosureScopeClass()
            ) {
